...
const Dashboard = () => {
  ...
  const constructionARApplications = [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1581094271901-8022df4466f9", // Updated construction-specific image
     ...
     <aside className="w-64 p-5 flex flex-col border-r" style={{ borderColor: themeColors.primaryPurple + '40' }}>
                     <nav className="flex-1">
                         <ul className="space-y-3">
                             {[{ label: "🏠 Home", tab: "home" }, { label : "📁 My Projects",  tab: "project" }, { label: " 🎨 Media", tab: "mediafiles" }, { label: "⚙️ Settings", tab: "settings" }, {label: " 📊 Analytics "}].map((item) => (
                                 <li key={item.tab}>
                                     <button
